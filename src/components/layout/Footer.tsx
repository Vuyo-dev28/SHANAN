...
//     title: "Our Work",
//     links: [
//       { label: "Orphanage Support", href: "/orphanage" },
//       { label: "GBV Awareness", href: "/gbv" },
//       { label: "Teen Pregnancy", href: "/teen-pregnancy" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              {/* <p>
                📧 <a href="mailto:info@shanan.org" className="hover:text-primary">info@shanan.org</a>
              </p>
              <p>
